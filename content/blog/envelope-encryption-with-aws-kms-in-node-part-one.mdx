...
This project was developed using Node.js 26.3.0 and pnpm 11.7.0. In the remaining part of this article, I will assume you manage your tooling using [mise-en-place](https://mise.jdx.dev/).
...
Initialize a Node.js project using pnpm and enable native ESM import syntax:
...
Put it all together in `src/index.mts` (create a new directory and file):

```ts filename="src/index.mts"
const message = "All your base are belong to us.";
const key = await crypto.subtle.generateKey({ name: "AES-GCM", length: 256 }, true, [
  "encrypt",
  "decrypt",
