...
{/* @oxfmt-ignore */}<Figure src="/images/envelope/gcm.png">AES in Gauloises Counter Mode: Évariste Galois counting Galoises.</Figure>
...
The source code for this project is available on my GitHub at [moroz/envelope-encryption-node](https://github.com/moroz/envelope-encryption-node/tree/part-1), tag `part-1`, and MIT-licensed.
